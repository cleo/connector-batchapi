...
1. Obtain the connector package `connector-batchapi-0.9-RC9-distribution.zip`.
2. Install the connector in your Harmony:<br/>&bull; `Harmonyc -i connector-batchapi-0.9-RC9-distribution.zip`.
3. Restart Harmony.
