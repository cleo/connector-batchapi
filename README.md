...
1. Obtain the connector package `connector-batchapi-0.9-RC8-distribution.zip`.
2. Install the connector in your Harmony:<br/>&bull; `Harmonyc -i connector-batchapi-0.9-RC8-distribution.zip`.
3. Restart Harmony.
...
`connector-batchapi-0.9-RC8-commandline.jar`.

If Java and the command line jar are properly installed, the following will work:

```
$ java -jar connector-batchapi-0.9-RC8-commandline.jar --help
...
```
java -jar connector-batchapi-0.9-RC8-commandline.jar --url https://192.168.7.22 -u administrator -p Admin --save
```
...
```
java -jar connector-batchapi-0.9-RC8-commandline.jar -i test.yaml
```
...
```
java -jar connector-batchapi-0.9-RC8-commandline.jar -i - <<< '{"operation":"list","username":"bob"}'
```

or even more compactly

```
java -jar connector-batchapi-0.9-RC8-commandline.jar --operation list -i - <<< 'username: bob'
```
...
```
java -jar connector-batchapi-0.9-RC8-commandline.jar --operation list 'username: bob'
```
